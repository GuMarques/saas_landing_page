      ...
      >
        <div className="container">
          <div className="flex items-center">
            <div className="relative min-w-1/2 flex-540 max-xl:flex-280 max-lg:flex-256 max-md:flex-100 flex flex-col">
              <div className="mb-10">
                <img
                  alt="xora"
                  height={55}
              ...
              <p className="body-1 mb-10 max-w-md">
                Try it now for free on iOS, Android, PC, Mac - whatever your
